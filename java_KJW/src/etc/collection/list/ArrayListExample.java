...
//		String name = nick[3]; (x)
		...
		System.out.println("3번의 인덱스의 값: " + name);
		...
		System.out.println(nick.contains("병아리"));
		...
		score.add(65); //알아서 인티져 타입으로 포장되어 넘어간다.
		
		//한번에 객체 많이 추가하기
		Collections.addAll(score, 78, 100, 88, 99, 100, 21, 56, 100);
