...
public class ParseQuiz {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if(ssn.indexOf("-")==-1) {//하이픈을 체크하기 전 length 먼저 판단하기
				System.out.println("하이픈 포함해서 입력해줴요.");
				continue;
			} 
			c = ssn.charAt(7); //담아놓을 공간
			if(!(c == '1' || c=='2' || c=='3' || c=='4')) {
				//1,2,3,4중 하나라도 없다면 false가 맞다면
			...
			System.out.printf("%d년 %d월 %ddlf %d세 %s\n"
