...
/*
	 ...
	 1. 매개 변수는 매서드를 호출 할 때, 메서드 실행에 필요한 값들을
...
public class MethodExaample2 {
	...
	static int calNumberTotal2(int...nums) {
		int total = 0;
		for(int i: nums) {
			total += i;
	...
	public static void main(String[] args) {
		...
		//배열로 포장해서 보내도 됩니다.
		sum = calNumberTotal2(1,2,3,4,5,6,7);
		System.out.println("누적합: " + sum);
