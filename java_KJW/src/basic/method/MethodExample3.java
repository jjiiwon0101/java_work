...
/*
		 ...
		 2. 매개변수는 여려 개 존재할 수 있지만, 반환값은 오직 한 개만
		 존재해야 합니다. 매서드 하나당 리턴 하나라 생각하자.
		 ...
		 6. 모든 메서드가 반환값이 있느 것은 아닙니다. 메서드 실행 후에
...
public class MethodExample3 {
	...
	static double[] calcArrayTotal (int[] number) {
		int total = 0;
		for(int r : number) {
			total += r;
		}
	...
	public static void main(String[] args) {
		...
		System.out.println();
		/*
		 1. 메서드 이름은 clacArrayTotal로 정의하겠습니다.
		 2. 이 메서드는 정수 배열을 하나 전달바아서 해당 배열 내부에 있는 
